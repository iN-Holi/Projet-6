...
exports.createSauce = (req, res, next) => {
  ...
  delete sauceObject._userId; // empeche quelqu un de ,mal intentionner de faire une requete avec son token en envoyeant le userid de quelqu un d autre
...
exports.deleteSauce = (req, res, next) => {
  Sauce.findOne({_id: req.params.id}) // on recherche dans la bdd la sauce avec son id 
    .then((sauce) => {
        ...
        } else {  // Suppression de la sauce et de l'image
